...
class _TransactionHistoryWidgetModel {
  bool trsIsSent = true;
}

class _TransactionHistoryWidgetState extends State<TransactionHistoryWidget> {
  late _TransactionHistoryWidgetModel _model;

  @override
  void initState() {
    super.initState();
    _model = _TransactionHistoryWidgetModel();
    _model.trsIsSent = true;
  }
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: ToggleIcon(
                      onPressed: () async {
                        safeSetState(
                            () => _model.trsIsSent = !_model.trsIsSent);
                      },
                      value: _model.trsIsSent,
                      onIcon: Icon(
