...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => const StartingPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Userpage')
              : const UserpageWidget(),
        ),
        FFRoute(
          name: ParametersWidget.routeName,
          path: ParametersWidget.routePath,
          builder: (context, params) => const ParametersWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => const PinnedUsersWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => const MethodOrderWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => const HashingpageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => const MAIN001CopyWidget(),
        )
