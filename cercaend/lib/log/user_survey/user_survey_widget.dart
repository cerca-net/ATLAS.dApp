                                                                      ...
                                                                      return InkWell(
                                                                        ...
                                                                        onTap:
                                                                          ...
                                                                          if (selectedMedia != null &&
                                                                            ...
                                                                            safeSetState(() =>
                                                                                _model.isDataUploading_uploadData7b4 = true);
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          decoration:
                                                                            ...
                                                                            image:
                                                                              ...
                                                                              fit: BoxFit.cover,
                                                                              image: Image.network(
                                                                                _model.uploadedFileUrl_uploadData7b4,
                                                                              ).image,
                                                                            ),
                                                                            borderRadius:
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return InkWell(
                                                                          ...
                                                                          onTap:
                                                                            ...
                                                                            if (selectedMedia != null &&
                                                                                selectedMedia.every((m) => validateFileFormat(m.storagePath, context))) {
                                                                              safeSetState(() => _model.isDataUploading_uploadDataRav = true);
                                                                              ...
                                                                              try {
                                                                                ...
                                                                                _model.isDataUploading_uploadDataRav = false;
                                                                              }
                                                                              if (selectedUploadedFiles.length == selectedMedia.length && downloadUrls.length == selectedMedia.length) {
                                                                                safeSetState(() {
                                                                                  _model.uploadedLocalFile_uploadDataRav = selectedUploadedFiles.first;
                                                                                  _model.uploadedFileUrl_uploadDataRav = downloadUrls.first;
                                                                                });
                                                                              } else {
                                                                                safeSetState(() {});
                                                                                return;
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            decoration:
                                                                              ...
                                                                              image: DecorationImage(
                                                                                fit: BoxFit.cover,
                                                                                image: Image.network(
                                                                                  _model.uploadedFileUrl_uploadDataRav,
                                                                                ).image,
                                                                              ),
                                                        ...
                                                        return FlutterFlowIconButton(
                                                          ...
                                                          onPressed: () async {
                                                            await currentUserReference!
                                                              ...
                                                              banner: _model
                                                                  .uploadedFileUrl_uploadData7b4,
                                                              profilePicture: _model
                                                                  .uploadedFileUrl_uploadDataRav,
                                                              name: _model
                                                                  .textController1
                                                                  .text,
                                                              surname: _model
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'z4pso157' /* Select your users occupation */,
                                              ),
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyMedium
                                                  ...
                                                  options: [
                                                    ...
                                                    ChipData(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'l90ugofi' /* Professional Services */,
                                                        ),
                                                        Icons.people),
                                                    ChipData(
                                                        FFLocalizations.of(
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '90bavbxd' /*  Tell us about your interests */,
                                              ),
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyMedium
