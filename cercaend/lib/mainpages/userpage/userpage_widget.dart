                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Row(
                                                                          children: [
                                                                            InkWell(
                                                                              onTap: () async {
                                                                                await Clipboard.setData(ClipboardData(text: FFAppState().walletAddress));
                                                                                ScaffoldMessenger.of(context).showSnackBar(
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            Row(
                                                                              children: [
                                                                                Container(
                                                                                  padding: const EdgeInsets.all(8),
                                                                                  decoration: BoxDecoration(
                                                                                    color: (_model.nodeStatus?.state == 'running')
                                                                                        ? Colors.green.withOpacity(0.2)
                                                                                        : (_model.nodeStatus?.state == 'paused')
                                                                                  ...
                                                                                  child: Icon(
                                                                                    Icons.dns_rounded,
                                                                                    color: (_model.nodeStatus?.state == 'running') ? Colors.greenAccent : (_model.nodeStatus?.state == 'paused' ? Colors.amber : Colors.redAccent),
                                                                                    size: 20,
                                                                                  ),
                                                                                ),
                                                                                const SizedBox(width: 12),
                                                                                Column(
                                                                                  ...
                                                                                  children: [
                                                                                    Text(
                                                                                      (_model.networkStatus?.isValidator == true) ? 'VALIDATOR NODE' : 'OBSERVER MODE',
                                                                                      style: GoogleFonts.outfit(
                                                                                        color: Colors.white,
                                                                                        fontSize: 14,
                                                                                        fontWeight: FontWeight.bold,
                                                                                    ...
                                                                                    Text(
                                                                                      (_model.nodeStatus?.state == 'running') ? 'Node Running & Earning' : (_model.nodeStatus?.state == 'paused' ? 'Node Paused' : 'Node Offline'),
                                                                            ...
                                                                            Container(
                                                                              ...
                                                                              decoration: BoxDecoration(
                                                                                color: (_model.networkStatus?.isValidator == true) ? Colors.green.withOpacity(0.2) : Colors.grey.withOpacity(0.2),
                                                                                borderRadius: BorderRadius.circular(12),
                                                                              ),
                                                                              child: Row(
                                                                                children: [
                                                                                  Container(
                                                                                    ...
                                                                                    height: 8,
                                                                                    decoration: BoxDecoration(
                                                                                      color: (_model.nodeStatus?.state == 'running') ? Colors.greenAccent : (_model.nodeStatus?.state == 'paused' ? Colors.amber : Colors.grey),
                                                                                      shape: BoxShape.circle,
                                                                                    ),
                                                                                  ),
                                                                                  const SizedBox(width: 6),
                                                                                  Text(
                                                                                    (_model.networkStatus?.isValidator == true) ? 'ONLINE' : 'OFFLINE',
                                                                                  ...
                                                                                  children: [
                                                                                    const Row(
                                                                                      children: [
                                                                                        ...
                                                                                        SizedBox(width: 4),
                                                                                        Text('STAKED', style: TextStyle(color: Colors.black54, fontSize: 10, fontWeight: FontWeight.w600)),
                                                                                      ],
                                                                                    ),
                                                                                    const SizedBox(height: 6),
                                                                                    Text(
                                                                                      '${_model.networkStatus?.stakeAmount ?? 0}',
                                                                                      style: GoogleFonts.outfit(
                                                                                    ...
                                                                                    const Text('TCOIN', style: TextStyle(color: Colors.black54, fontSize: 10)),
                                                                                  ],
                                                                                ),
                                                                              ),
                                                                            ),
                                                                                  ...
                                                                                  children: [
                                                                                    const Row(
                                                                                      children: [
                                                                                        ...
                                                                                        SizedBox(width: 4),
                                                                                        Text('REWARDS', style: TextStyle(color: Colors.white54, fontSize: 10, fontWeight: FontWeight.w600)),
                                                                                      ],
                                                                                    ),
                                                                                    const SizedBox(height: 6),
                                                                                    Text(
                                                                                      '${_model.networkStatus?.rewardsEarned ?? 0}',
                                                                                      style: GoogleFonts.outfit(
                                                                                        color: Colors.white,
                                                                                        fontSize: 22,
                                                                                        fontWeight: FontWeight.bold,
                                                                                    ...
                                                                                    const Text('TCOIN', style: TextStyle(color: Colors.white38, fontSize: 10)),
                                                                                  ],
                                                                                ),
                                                                              ),
                                                                            ),
                                                                        ...
                                                                        if (_model.networkStatus?.isValidator !=
                                                                            true) ...[
                                                                          Container(
                                                                            padding:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              crossAxisAlignment: CrossAxisAlignment.start,
                                                                              children: [
                                                                                const Text('Become a Validator', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 13)),
                                                                                const SizedBox(height: 4),
                                                                                const Text('Stake TCOIN to earn rewards for securing the network.', style: TextStyle(color: Colors.white54, fontSize: 11)),
                                                                                const SizedBox(height: 12),
                                                                                Row(
                                                                                  children: [
                                                                                    Expanded(
                                                                                      child: TextFormField(
                                                                                        controller: _model.stakeAmountController,
                                                                                        style: const TextStyle(color: Colors.white),
                                                                                        keyboardType: TextInputType.number,
                                                                                        decoration: InputDecoration(
                                                                                    ...
                                                                                    const SizedBox(width: 12),
                                                                                    ElevatedButton(
                                                                                      onPressed: _model.isWalletLoading ? null : _registerValidator,
                                                                                      style: ElevatedButton.styleFrom(
                                                                                        backgroundColor: const Color(0xFFF83B46),
                                                                                        foregroundColor: Colors.white,
                                                                                        padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 12),
                                                                                      ),
                                                                                      child: _model.isWalletLoading ? const SizedBox(width: 16, height: 16, child: CircularProgressIndicator(strokeWidth: 2, color: Colors.white)) : const Text('STAKE', style: TextStyle(fontWeight: FontWeight.w600)),
                                                                                    ),
                                                                                  ],
                                                                                ),
                                                                              ],
                                                                        ...
                                                                        if (_model.networkStatus?.isValidator ==
                                                                          ...
                                                                          Container(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                                                              children: [
                                                                                _buildControlBtn(Icons.play_arrow, 'Start', Colors.green, () async {
                                                                                  await _blockchainService.startNode();
                                                                                  await _fetchNodeStatus();
                                                                                  await _fetchNodeLogs();
                                                                                }),
                                                                                _buildControlBtn(Icons.pause, 'Pause', Colors.amber, () async {
                                                                                  await _blockchainService.pauseNode();
                                                                                  await _fetchNodeStatus();
                                                                                  await _fetchNodeLogs();
                                                                                }),
                                                                                _buildControlBtn(Icons.stop, 'Stop', Colors.red, () async {
                                                                                  await _blockchainService.stopNode();
                                                                                  await _fetchNodeStatus();
                                                                                  await _fetchNodeLogs();
                                                                                }),
                                                                                _buildControlBtn(Icons.sync, 'Sync', Colors.blue, () async {
                                                                          ...
                                                                          Container(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Column(
                                                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                                                children: _model.nodeLogs.isEmpty
                                                                                    ? [
                                                                                        const Text('Waiting for node activity...', style: TextStyle(color: Colors.white24, fontSize: 10))
                                                                                      ]
                                                                                    : _model.nodeLogs.map((log) => _buildLogEntry('[${log.timestamp.split(' ').last}] ${log.message}', log.level)).toList(),
                                                                              ),
                                                                            ),
                                                                          ),
                                                                        ],
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          GridView
                                                                            ...
                                                                            childAspectRatio:
                                                                                1.3,
                                                                            children: [
                                                                              _buildNetworkMetric('Block Height', '${_model.networkStatus!.blockHeight}', Icons.layers),
                                                                              _buildNetworkMetric('TX Pool', '${_model.networkStatus!.txPoolSize}', Icons.receipt_long),
                                                                              _buildNetworkMetric('Validators', '${_model.networkStatus!.totalValidators}', Icons.people),
                                                                            ],
                                                                          ),
                                                                        ],
                                                                      ),
