...
start "ATLAS Node 2" powershell -NoExit -Command "Set-Location '%~dp0ATLAS.BC0.0.1'; go run cmd/main.go -port 8001 -api 8081 -datadir ./data_node2 -validator-key node2.key"
